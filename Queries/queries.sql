...
-- Deleting the whole retirement_info table 
...
-- Joining retirement_info and dept_emp tables to find out who are currently employed and make a new table
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
	de.to_date
...
SELECT * FROM dept_info
WHERE dept_info.dept_name IN ('Sales');
